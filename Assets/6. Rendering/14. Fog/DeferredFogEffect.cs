...
namespace Rendering
{
	...
	{
		public Shader deferredFog = default;
		[NonSerialized]	Material fogMaterial = default;
		[NonSerialized] Camera deferredCamera = default;
		[NonSerialized] Vector3[] frustumCorners = default;
		[NonSerialized]	Vector4[] vectorArray = default;
